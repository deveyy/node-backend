...
## API Endpoints
- The actual endpoints for the application can be found inside the folder named `endpoints` [https://github.com/deveyy/bdigital-backend/tree/develop/endpoints](https://github.com/deveyy/bdigital-backend/tree/develop/endpoints). 
